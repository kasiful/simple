...
@section('title', 'Manajemen Data / Edit Entrian')
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <select id="kode-xx" name="prov" class="form-control custom-select-sm">
                                                    ...
                                                    <?php
                                                    foreach ($prov as $x) {
                                                        if ($info_alamat->prov_id == $x->id) {
                                                            echo "<option value='{$x->id}' selected>{$x->provinsi}</option>";
                                                        } else {
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <select id="kode-xxxx" name="kab" class="form-control custom-select-sm">
                                                    ...
                                                    <?php
                                                    foreach ($kab as $x) {
                                                        if ($info_alamat->kab_id == $x->kab_id) {
                                                            echo "<option class='kode-{$x->prov_id}' value='{$x->kab_id}' selected>{$x->kab}</option>";
                                                        } else {
                                            ...
                                            <td colspan="3">
                                                <select id="kode-xxxxxx" name="kantor_unit" class="form-control custom-select-sm">
                                                    ...
                                                    foreach ($kantor_unit as $x) {
                                                        if ($info_alamat->kantor_unit_id == $x->kantor_unit_id) {
                                                            echo "<option class='kode-{$x->prov_id} kode-{$x->kab_id}' value='{$x->kantor_unit_id}' selected>{$x->kantor_unit}</option>";
                                                        } else {
                                            ...
                                            <td colspan="3">
                                                <select id="kode-xxxxxxxx" name="pelabuhan_id" class="form-control custom-select-sm">
                                                    ...
                                                    foreach ($pelabuhan as $x) {
                                                        if ($info_alamat->pelabuhan_id == $x->pelabuhan_id) {
                                                            echo "<option class='kode-{$x->prov_id} kode-{$x->kab_id} kode-{$x->kantor_unit_id}' value='{$x->pelabuhan_id}' selected>{$x->pelabuhan}</option>";
                                                        } else {
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control  custom-select-sm" name="bulan">
                                                    <?php foreach ($bulan as $key => $val) { ?>
                                                        <option value="<?php echo $key + 1 ?>" <?php if ($d1->bulan == ($key + 1)) echo "selected" ?>><?php echo $val ?></option>
                                                    <?php } ?>
                                                </select>
                                            </td>
